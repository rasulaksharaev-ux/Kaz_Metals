    ...
    if step == "offer_price":
        ...
        await context.bot.send_message(
            ...
            text=(
                ...
                f"👤 Покупатель: {buyer.get('first_name','')} {buyer.get('last_name','')}\n"
...
async def video_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if states.get(user_id, {}).get("step") == "ad_extra_media":
        ...
        await update.message.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("✅ Готово, перейти к предпросмотру", callback_data="skip_extra_media")]]),
        )
...
async def photo_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if step == "ad_photo":
        ...
        await update.message.reply_text(
            "✅ Главное фото сохранено.\n\n📌 ДОПОЛНИТЕЛЬНЫЕ ФОТО/ВИДЕО\nОтправьте дополнительные фото/видео одним или несколькими сообщениями.\n\nКогда закончите, нажмите кнопку ниже: ✅ Готово, перейти к предпросмотру.",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("✅ Готово, перейти к предпросмотру", callback_data="skip_extra_media")]]),
        )
