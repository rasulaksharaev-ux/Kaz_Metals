...
_KW_REQUIRED = [
    ...
    "ювелир", "кольцо", "кольца", "серьги", "браслет", "украшени",
    "слиток", "аффинаж", "пробирн",
    "проба золота", "проба серебра",
    "лом золота", "скупка золота",
    "монета золот", "монеты золот",
    "запасы золота", "резервы золота", "цена золота", "курс золота",
    "нбрк золото", "нацбанк золото",
    # Часы — люкс и драгметаллы
    "золотые часы", "часы из золота", "платиновые часы",
    "серебряные часы", "ювелирные часы", "роскошные часы",
    "люксовые часы", "швейцарские часы", "коллекционные часы",
    "rolex", "ролекс", "patek philippe", "патек", "audemars",
    "vacheron", "cartier часы", "breguet", "hublot",
]
...
def _emoji(title: str, idx: int) -> str:
    ...
    elif any(w in t for w in ["ювелир","кольц","серьг","брасле","украшен"]): cat = "jewelry"
    elif any(w in t for w in ["часы","rolex","ролекс","patek","audemars",
                               "vacheron","cartier","breguet","hublot"]): cat = "watch"
