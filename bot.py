...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    in_group = await check_membership(context.bot, user_id)

    if user and user.get("status") == "active" and in_group:
    ...
    elif user and user.get("status") == "active" and not in_group:
        # Зарегистрирован но не в группе
