                ...
                try:
                    await context.bot.send_message(
                        ...
                        text=(
                            ...
                            "KAZ_METALS — это закрытая площадка с системой репутации и верификации. "
    ...
    if data == "menu_safety":
        await context.bot.send_message(
            ...
            text=(
                ...
                "Безопасность участников — приоритет №1 KAZ_METALS. "
...
async def _finalize_registration(update_or_query, context: ContextTypes.DEFAULT_TYPE, user_id: str, city: str):
    ...
    welcome_text = (
        ...
        f"{name}, добро пожаловать в KAZ_METALS 🇰🇿\n\n"
        f"Ваш профиль:\n"
        f"👤 Имя: {name}\n"
        f"📱 Телефон: {phone}\n"
        f"📍 Город: {city}\n\n"
        f"Осталось вступить в группу:\n"
        f"1️⃣ Нажмите «Вступить в KAZ_METALS»\n"
...
async def group_member_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Отслеживает изменения членства в группе KAZ_METALS.
