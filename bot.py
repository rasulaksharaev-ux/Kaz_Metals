...
async def _groq_filter(articles: list) -> list:
    ...
    prompt = (
        "Ты редактор Telegram-канала KAZ_METALS про рынок драгоценных металлов и люкс-товаров в Казахстане.\n\n"
        "Разделы канала: Новости рынка, Серьги, Кольца, Подвески/Браслеты, Монеты, Exclusive, Часы, Камни, Слитки, Лом и скупка.\n\n"
        "ПРИОРИТЕТ новостей: Казахстан > США/Европа > остальные страны.\n\n"
        "ОСТАВЬ если новость про:\n"
        "- Цены/тренды золота, серебра, платины, палладия\n"
        "- Люксовые часы: аукционы, новинки, рекордные продажи (Rolex, Patek, Cartier и др.)\n"
        "- Рынок ювелирных украшений: тренды, коллекции брендов, ювелирные выставки\n"
        "- Драгоценные камни: аукционные продажи, рекорды стоимости\n"
        "- Монеты НацБанка, инвестиционные монеты\n"
        "- Рынок слитков, цены на лом золота/серебра\n"
        "- Важные события влияющие на рынок: решения ФРС, ЦБ, крупные сделки\n"
        "- ИСКЛЮЧИТЕЛЬНЫЕ события: рекордные находки проданные на аукционе, исторические рекорды\n\n"
        "УДАЛИ если:\n"
        "- Контрабанда, таможня, изъятие (нашли в штанах, в посылке, в кармане, в джинсах)\n"
        "- Случайные находки без рыночной ценности\n"
        "- Спорт (золото как чемпионство)\n"
        "- Война/политика без связи с ценами металлов\n"
        "- Общие советы по инвестированию без новостного повода\n"
        "- Российские бытовые истории без международной ценности\n\n"
        f"Заголовки:\n{titles_text}\n\n"
        "Ответь ТОЛЬКО JSON-массивом номеров которые нужно ОСТАВИТЬ. Пример: [1,3,5]\n"
