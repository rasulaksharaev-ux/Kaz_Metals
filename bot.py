    ...
    if data == "menu_how":
        await context.bot.send_message(
            ...
            text="📋 Как работает ALTYN_TRUST\n\n"
                 ...
                 "🔷 Для покупателя\n"
                 "1. Зайдите в группу ALTYN_TRUST\n"
                 ...
                 "⚖️ Правовая оговорка\n"
                 "ALTYN_TRUST — платформа-посредник. Мы соединяем продавцов и покупателей, но не являемся стороной сделок. Безопасность участников — наш приоритет.",
            reply_markup=main_menu_keyboard(),
        )
        return
