...
# Ключевые слова по теме группы KAZ_METALS
NEWS_KEYWORDS = [
    # Металлы
    "золото", "серебро", "платина", "палладий", "металл", "драгоценн",
    # Ювелирка
    "ювелир", "кольц", "серьг", "брасле", "подвеск", "украшен", "проба", "аффинаж",
    # Инвестиции/финансы
    "инвестиц", "слиток", "монет", "лом", "скупка", "ломбард",
    # Казахстан специфика
    "нбрк", "нацбанк", "тенге", "пробирн", "казахстан",
    # Английские (для международных источников)
    "gold", "silver", "platinum", "palladium", "precious metal", "bullion",
