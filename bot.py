...
def main():
    ...
    app.add_handler(CommandHandler("open_prices", open_prices_cmd))
    ...
    app.add_handler(CommandHandler("test_alert", test_alert_cmd))
    ...
    if GROUP_ID and app.job_queue is not None:
        ...
        app.job_queue.run_repeating(deviation_alert_job, interval=1800, first=60)
