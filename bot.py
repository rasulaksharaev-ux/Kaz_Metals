...
_RSS_FEEDS = [
    # ══ КАЗАХСТАН - работающие источники ══
    ("https://kapital.kz/rss.xml",                     "kapital.kz"),
    ("https://tengrinews.kz/rss/",                     "tengrinews.kz"),
    ("https://forbes.kz/rss/",                         "forbes.kz"),

    # ══ GOOGLE NEWS - 8 разных запросов по всем сегментам группы ══
    # Золото и серебро - Казахстан
    (
        "https://news.google.com/rss/search"
        "?q=%D0%B7%D0%BE%D0%BB%D0%BE%D1%82%D0%BE+%D1%81%D0%B5%D1%80%D0%B5%D0%B1%D1%80%D0%BE+%D0%9A%D0%B0%D0%B7%D0%B0%D1%85%D1%81%D1%82%D0%B0%D0%BD+%D0%9D%D0%91%D0%A0%D0%9A"
        "&hl=ru&gl=KZ&ceid=KZ:ru",
        "google.news"
    ),
    # Цены на золото - мировые
    (
        "https://news.google.com/rss/search"
        "?q=%D1%86%D0%B5%D0%BD%D0%B0+%D0%B7%D0%BE%D0%BB%D0%BE%D1%82%D0%B0+%D1%80%D1%8B%D0%BD%D0%BE%D0%BA+%D0%BC%D0%B5%D1%82%D0%B0%D0%BB%D0%BB%D0%BE%D0%B2"
        "&hl=ru&gl=RU&ceid=RU:ru",
        "google.news"
    ),
    # Драгметаллы инвестиции
    (
        "https://news.google.com/rss/search"
        "?q=%D0%B4%D1%80%D0%B0%D0%B3%D0%BE%D1%86%D0%B5%D0%BD%D0%BD%D1%8B%D0%B5+%D0%BC%D0%B5%D1%82%D0%B0%D0%BB%D0%BB%D1%8B+%D0%B8%D0%BD%D0%B2%D0%B5%D1%81%D1%82%D0%B8%D1%86%D0%B8%D0%B8"
        "&hl=ru&gl=RU&ceid=RU:ru",
        "google.news"
    ),
    ...
    (
        "https://news.google.com/rss/search"
        "?q=%D1%8E%D0%B2%D0%B5%D0%BB%D0%B8%D1%80%D0%BD%D1%8B%D0%B5+%D1%83%D0%BA%D1%80%D0%B0%D1%88%D0%B5%D0%BD%D0%B8%D1%8F+%D0%B7%D0%BE%D0%BB%D0%BE%D1%82%D0%BE"
        "&hl=ru&gl=RU&ceid=RU:ru",
        "google.news"
    ),
    # Люксовые часы аукцион
    (
        "https://news.google.com/rss/search"
        "?q=%D1%87%D0%B0%D1%81%D1%8B+Rolex+Patek+%D0%B0%D1%83%D0%BA%D1%86%D0%B8%D0%BE%D0%BD+%D0%BB%D1%8E%D0%BA%D1%81"
        "&hl=ru&gl=RU&ceid=RU:ru",
        "google.news"
    ),
    # Бриллианты камни аукцион
    (
        "https://news.google.com/rss/search"
        "?q=%D0%B1%D1%80%D0%B8%D0%BB%D0%BB%D0%B8%D0%B0%D0%BD%D1%82%D1%8B+%D0%B0%D0%BB%D0%BC%D0%B0%D0%B7+%D0%B0%D1%83%D0%BA%D1%86%D0%B8%D0%BE%D0%BD+%D1%80%D0%B5%D0%BA%D0%BE%D1%80%D0%B4"
        "&hl=ru&gl=RU&ceid=RU:ru",
        "google.news"
    ),
    # Монеты НБРК слитки
    (
        "https://news.google.com/rss/search"
        "?q=%D0%BC%D0%BE%D0%BD%D0%B5%D1%82%D1%8B+%D1%81%D0%BB%D0%B8%D1%82%D0%BA%D0%B8+%D0%B7%D0%BE%D0%BB%D0%BE%D1%82%D0%BE+%D0%9A%D0%B0%D0%B7%D0%B0%D1%85%D1%81%D1%82%D0%B0%D0%BD"
        "&hl=ru&gl=KZ&ceid=KZ:ru",
        "google.news"
    ),
    # Платина палладий серебро рынок
    (
        "https://news.google.com/rss/search"
        "?q=%D0%BF%D0%BB%D0%B0%D1%82%D0%B8%D0%BD%D0%B0+%D0%BF%D0%B0%D0%BB%D0%BB%D0%B0%D0%B4%D0%B8%D0%B9+%D1%86%D0%B5%D0%BD%D0%B0"
        "&hl=ru&gl=RU&ceid=RU:ru",
        "google.news"
    ),
...
async def _groq_filter(articles: list) -> list:
    ...
    prompt = (
        ...
        "Разделы канала: цены металлов, ювелирные украшения, люксовые часы, "
        "драгоценные камни, монеты, слитки, лом и скупка.\n\n"
        "ЗАДАЧА: Выбери от 5 до 8 заголовков для публикации.\n\n"
        "ПРАВИЛА ВЫБОРА:\n"
        "1. Если несколько заголовков про одно и то же (разные слова, один смысл) - "
        "оставь ТОЛЬКО ОДИН лучший\n"
        "2. Приоритет: Казахстан > США/Европа > Россия\n"
        "3. Предпочитай: цены, рекорды, аукционы, новинки брендов\n"
        "4. УДАЛИ только явный мусор: кражи, спорт, война\n"
        "5. Если 5+ хороших заголовков - возьми все, не будь слишком строгим\n\n"
        f"Заголовки:\n{titles_text}\n\n"
        "Ответь ТОЛЬКО JSON-массивом номеров. Пример: [1,3,5,7,9,12]\n"
        "Выбери минимум 5 если есть подходящие. Только JSON."
    )
...
async def _do_fetch_and_post(bot) -> list:
    ...
    for art in articles:
        ...
        try:
            ...
            _SENT_HASHES.add(art["hash"])  # добавляем ТОЛЬКО после успешной отправки
