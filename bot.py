...
async def _do_fetch_and_post(bot) -> list:
    ...
    for art in articles:
        ...
        # Вариант Г: мигающая красная точка при появлении поста
        text_on  = "\n".join([
        ...
        try:
            ...
            for _ in range(3):
                ...
                try:
                    await bot.edit_message_text(text=text_off, **_blink_kwargs)
                    await _asyncio.sleep(0.7)
                    await bot.edit_message_text(text=text_on,  **_blink_kwargs)
                except Exception:
                    break   # не страшно если Telegram притормозил
