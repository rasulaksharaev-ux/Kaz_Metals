...
async def publish_ad(context: ContextTypes.DEFAULT_TYPE, chat_id: int, user_id: str):
    ...
    try:
        ...
        price_fmt = f"{raw_price} ₸" if raw_price else "—"
    ...
    buttons.append([InlineKeyboardButton(f"💰 Купить за {price_btn}", url=f"https://t.me/{BOT_USERNAME}?start=buy_{user_id}_{ad_id}")])
