...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user and user.get("status") == "reset":
        ...
        await update.message.reply_text(
            ...
            "Закрытая площадка для покупки и продажи "
            "ювелирных украшений, часов, монет и драгоценностей "
            "в Казахстане.\n\n"
            "Здесь можно найти: кольца, серьги, браслеты, "
            "часы, инвестиционные монеты, драгоценные камни "
            "и эксклюзивные изделия.",
            reply_markup=InlineKeyboardMarkup([
